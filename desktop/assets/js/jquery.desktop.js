    ...
    init: {
      ...
      desktop: function() {
        ...
        d.on('dblclick', 'a.icon', function() {
		  ...
		  var formId = iconId.substring(5);
		  var taskId = 'dock_' + formId;
	      var $task = $('#' + taskId).parent();
		  var $form = $('#' + formId);
		  
          // Show the taskbar button.
          if ($task.is(':hidden')) {
            $task.remove().appendTo('#dock');
            $task.show('fast');
          }
		 
          // Bring window to front.
          JQD.util.window_flat();
          $form.addClass('window_stack').show();
        });
        ...
        d.on('click', '#dock a', function() {
		  ...
		  var formId = taskId.substring(5);
		  //var iconId = 'icon_' + taskId.substring(5);
		  var $form = $('#' + formId);
          ...
          if ($form.is(':visible')) {
            ...
            // Bring window to front.
            JQD.util.window_flat();
            $form.show().addClass('window_stack');
          }
        });
        ...
        d.on('dblclick', 'div.window_top img', function() {
		  ...
		  var formId = $(this).closest('div.window').attr('id');
		  var $form = $('#' + formId)
		  var $task = $('#dock_' + formId);
		  
		  $form.hide();
		  $task.parent().hide('fast');
        ...
        d.on('click', 'a.window_close', function() {
		  var $form = $(this).closest('div.window');
		  var $task = $('#dock_' + $form.attr("id"));
		  
		  $form.hide();
		  $task.closest('li').hide('fast');
